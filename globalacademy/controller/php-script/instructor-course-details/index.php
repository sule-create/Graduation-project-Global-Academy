    ...
    if($row_cnt_courses_tbl > 0)
    {
        ...
        echo '<div class="row">
            ...
            <div class="col-lg-8" align="left">
                <nav>';
                    $sqlGet_users_tbl = "SELECT * FROM `users_tbl` INNER JOIN assign_course_tbl ON users_tbl.sn=assign_course_tbl.user_id WHERE user_type = 'student' AND course_id='$course_id'";
                    ...
                    echo '<div class="nav nav-tabs" id="nav-tab" role="tablist">
                        <button class="nav-link active" id="nav-student-tab" data-bs-toggle="tab" data-bs-target="#nav-student" type="button" role="tab" aria-controls="nav-student" aria-selected="true">Students Offering<b> ('.$row_cnt_users_tbl.')</b></button>
                                ...
                                do{
                                    ...
                                    echo '<div class="col-lg-6 col-md-12 mt-3">
                                        <div style="display: flex; align-items: center;">
                                            <b>'.$cnt++.'.</b> &nbsp;&nbsp;&nbsp;<img class="round_instructor_loner" src="'.$row_users_tbl['photo'].'" style="width: 80px; height: 80px;" alt="user" />
