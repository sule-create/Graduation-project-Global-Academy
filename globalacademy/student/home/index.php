...
<body>
    <div class="grid-container">
        ...
        <?php
            ...
            $sqlGet_courses_tbl_reg = "SELECT * FROM `assign_course_tbl` WHERE `user_id` = '$userid'";
            $result_courses_tbl_reg = mysqli_query($link, $sqlGet_courses_tbl_reg);
            $row_courses_tbl_reg = mysqli_fetch_assoc($result_courses_tbl_reg);
            $row_cnt_courses_tbl_reg = mysqli_num_rows($result_courses_tbl_reg);

            $not_reg = $row_cnt_courses_tbl - $row_cnt_courses_tbl_reg;
        ?>
        <!----Main----->
                        ...
                        <div class="row">
                            <div class="col-8">
                                ...
                                <div class="d-flex" style="padding-left:5px;padding-right:5px;color:#000000;font-weight:600;">
                                    <h4><?php echo $row_cnt_courses_tbl_reg; ?></h4>
                                </div>
                            </div>
