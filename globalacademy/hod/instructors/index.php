...
<!DOCTYPE html>
   ...
   <head>
    ...
    <title>Global Academy | Instructors</title>
    <!-- Favicon icon -->
   ...
   <body>
       ...
       <div class="grid-container">
           ...
           <main class="main-container mt-4">
                <div class="main-title">
                    <span class="font-weight-bold">Instructors(<span class="tot_instructor">0</span>)</span>
                </div>
                
                <div class="row display_instructors">
       ...
       <script>
            ...
            $(document).ready(function() {
                ...
                $(".display_instructors").html("<i class=\"fas fa-spinner fa-spin\"></i>");

                $.ajax({
                    type: 'POST',
                    url:"../../controller/php-script/get-instructors/",
                    data: {
                        email:email,
                        usertype:usertype
                    },
                    success: function (output) {
                        ...
                        $(".display_instructors").html(output);

                        $(".tot_instructor").html($('.tot_instructor_val').val());
            ...
            $('body').on('click', '.save_btn', function(){
                ...
                $.ajax({
                    type: 'POST',
                    url:"../../controller/php-script/assign-instructor-course/",
                    data: {
                        instructor:data_id,
            ...
            $('body').on('click', '.delete_instructor', function(){
                ...
                $.ajax({
                    type: 'POST',
                    url:"../../controller/php-script/delete-instructor/",
                    data: {
                        instructor:data_id
                    },
                    success: function (output) {
            ...
            $('body').on('click', '.view_course_student', function(){
                ...
                $.ajax({
                    type: 'POST',
                    url:"../../controller/php-script/instructor-course-details/",
                    data: {
                        courseid:data_id
                    },
                    success: function (output) {
