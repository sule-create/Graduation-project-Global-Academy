                                                ...
                                                do{
                                                    ...
                                                    echo '<div class="col-lg-4 col-md-6 mb-2">
                                                        <div class="card shadow">
                                                            <i class="fas fa-trash delete_schedule_btn delete_schedule_btn'.$sn_mon.'" style="margin-right: 10px;margin-top: 10px;margin-buttom: 0px;color:red;cursor:pointer;" align="right" data-id="'.$sn_mon.'"> Delete </i>
                                                            <div class="card-body">
                                        ...
                                        <?php
                                            ...
                                            if($row_cnt_course_schedule_tbl_tuesday > 0)
                                            {
                                                do{
                                                    ...
                                                    echo '<div class="col-lg-4 col-md-6 mb-2">
                                                        <div class="card shadow">
                                                            <i class="fas fa-trash delete_schedule_btn delete_schedule_btn'.$sn_tues.'" style="margin-right: 10px;margin-top: 10px;margin-buttom: 0px;color:red;cursor:pointer;" align="right" data-id="'.$sn_tues.'"> Delete </i>
                                                            <div class="card-body">
                                                                <div style="display: flex; align-items: center;">
                                        ...
                                        <?php
                                            ...
                                            if($row_cnt_course_schedule_tbl_wednesday > 0)
                                            {
                                                do{
                                                    ...
                                                    echo '<div class="col-lg-4 col-md-6 mb-2">
                                                        <div class="card shadow">
                                                            <i class="fas fa-trash delete_schedule_btn delete_schedule_btn'.$sn_wed.'" style="margin-right: 10px;margin-top: 10px;margin-buttom: 0px;color:red;cursor:pointer;" align="right" data-id="'.$sn_wed.'"> Delete </i>
                                                            <div class="card-body">
                                                                <div style="display: flex; align-items: center;">
                                        ...
                                        <?php
                                            ...
                                            if($row_cnt_course_schedule_tbl_thursday > 0)
                                            {
                                                do{
                                                    ...
                                                    echo '<div class="col-lg-4 col-md-6 mb-2">
                                                        <div class="card shadow">
                                                            <i class="fas fa-trash delete_schedule_btn delete_schedule_btn'.$sn_thur.'" style="margin-right: 10px;margin-top: 10px;margin-buttom: 0px;color:red;cursor:pointer;" align="right" data-id="'.$sn_thur.'"> Delete </i>
                                                            <div class="card-body">
                                                                <div style="display: flex; align-items: center;">
                                        ...
                                        <?php
                                            ...
                                            if($row_cnt_course_schedule_tbl_friday > 0)
                                            {
                                                do{
                                                    ...
                                                    echo '<div class="col-lg-4 col-md-6 mb-2">
                                                        <div class="card shadow">
                                                            <i class="fas fa-trash delete_schedule_btn delete_schedule_btn'.$sn_fri.'" style="margin-right: 10px;margin-top: 10px;margin-buttom: 0px;color:red;cursor:pointer;" align="right" data-id="'.$sn_fri.'"> Delete </i>
                                                            <div class="card-body">
                                                                <div style="display: flex; align-items: center;">
                                        ...
                                        <?php
                                            ...
                                            if($row_cnt_course_schedule_tbl_saturday > 0)
                                            {
                                                do{
                                                    ...
                                                    echo '<div class="col-lg-4 col-md-6 mb-2">
                                                        <div class="card shadow">
                                                            <i class="fas fa-trash delete_schedule_btn delete_schedule_btn'.$sn_sat.'" style="margin-right: 10px;margin-top: 10px;margin-buttom: 0px;color:red;cursor:pointer;" align="right" data-id="'.$sn_sat.'"> Delete </i>
                                                            <div class="card-body">
                                                                <div style="display: flex; align-items: center;">
                                        ...
                                        <?php
                                            ...
                                            if($row_cnt_course_schedule_tbl_sunday > 0)
                                            {
                                                do{
                                                    ...
                                                    echo '<div class="col-lg-4 col-md-6 mb-2">
                                                        <div class="card shadow">
                                                            <i class="fas fa-trash delete_schedule_btn delete_schedule_btn'.$sn_sun.'" style="margin-right: 10px;margin-top: 10px;margin-buttom: 0px;color:red;cursor:pointer;" align="right" data-id="'.$sn_sun.'"> Delete </i>
                                                            <div class="card-body">
                                                                <div style="display: flex; align-items: center;">
