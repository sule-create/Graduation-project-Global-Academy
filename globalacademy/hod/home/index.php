...
<body>
    <div class="grid-container">
        ...
        <?php
            $sqlGet_users_tbl_student = "SELECT * FROM `users_tbl` WHERE user_type = 'student'";
            ...
            $sqlGet_users_tbl_instructor = "SELECT * FROM `users_tbl` WHERE user_type = 'instructor'";
            $result_users_tbl_instructor = mysqli_query($link, $sqlGet_users_tbl_instructor);
            $row_users_tbl_instructor = mysqli_fetch_assoc($result_users_tbl_instructor);
            $row_cnt_users_tbl_instructor = mysqli_num_rows($result_users_tbl_instructor);
                        ...
                        <div class="row">
                            <div class="col-8">
                                ...
                                <div class="d-flex" style="padding-left:5px;padding-right:5px;color:#000000;font-weight:600;">
                                    <h4><?php echo $row_cnt_users_tbl_student; ?></h4>
                                </div>
                            </div>
                    ...
                    <div class="card" style="border:none; border-radius: 7px;background-color:#FFCBC9;padding:10px;">
                        <div class="row">
                            <div class="col-8">
                                ...
                                <div class="d-flex" style="padding-left:5px;padding-right:5px;color:#000000;font-weight:600;">
                                    <h4><?php echo $row_cnt_users_tbl_instructor; ?></h4>
                                </div>
                            </div>
                            <div class="col-4" style="text-align: center; display: flex; justify-content: center; align-items: center; color: #595757;">
                                <div style="display: inline-block;">
    ...
    <script>
        const xValues = ["Students", "Instructors", "Courses"];
        const yValues = [<?php echo $row_cnt_users_tbl_student;?>, <?php echo $row_cnt_users_tbl_instructor;?>, <?php echo $row_cnt_courses_tbl;?>];
        const barColors = [
            "#5cb85c",
            "#d9534f",
            "#0275d8"
        ...
        new Chart("myChart", {
            ...
            options: {
                title: {
                display: true,
                text: "Students, Instructors and Courses Statistics"
                }
            }
        });
    </script>
